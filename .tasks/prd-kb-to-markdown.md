...
Create a new agent skill named `kb-to-markdown` that instructs agents how to format synthesized knowledge into a structured markdown layout matching specific use cases, and how to insert/copy those sections into specified target files.

### User Stories / Requirements

- **task-01**: Create `skills/kb-to-markdown/SKILL.md` containing the markdown formatting rules, examples, and file insertion guidelines.
- **task-02**: Register the new skill in the repository root `README.md` in alphabetical order.
- **task-03**: Refine the `kb-to-markdown` skill specification.
...
- [x] **task-03**: Refine the `kb-to-markdown` skill specification
...
- [x] **task-01**: Create `skills/kb-to-markdown/SKILL.md`
  - [x] Create directory `skills/kb-to-markdown`
  - [x] Write `SKILL.md` with Yaml frontmatter and the 5 formatting templates (Case 1 to 5) as specified in [golden-templates.md](prd-kb-to-markdown/golden-templates.md)
  - [x] Add spacing and list styling rules (bold concepts, exactly 4-space nested list indentation, and blank line spacing) as defined in [golden-templates.md](prd-kb-to-markdown/golden-templates.md)
  - [x] Add file insertion and merging guidelines defined in [golden-templates.md](prd-kb-to-markdown/golden-templates.md)
- [x] **task-03**: Refine the `kb-to-markdown` skill specification
  - [x] Gather feedback and instructions on the required refinements from the user
  - [x] Wrap all template structures for Cases 1 to 4 in ```markdown code blocks inside `skills/kb-to-markdown/SKILL.md`
...
### task-01: Create `skills/kb-to-markdown/SKILL.md`
...
- **Checklist**:
  - [x] Create a dummy target markdown file (`scratch/test_readme.md`)
  - [x] Run a baseline test with a subagent (WITHOUT the skill loaded) and observe formatting failures
  - [x] Run a verification test with a subagent (WITH the skill loaded) using natural language triggers (Option A)
  - [x] Clean up temporary dummy files
